...
const Signup = () => {
  ...
  return (
    ...
    >
      ...
      {/* Container */}
      <div className="w-full max-w-5xl bg-white/98 backdrop-blur-xl rounded-xl shadow-[0_25px_70px_rgba(0,0,0,0.5)] overflow-hidden grid grid-cols-1 md:grid-cols-12 border border-white/30 min-h-[680px] relative z-10">
        ...
        <div className="md:col-span-5 bg-gradient-to-br from-[#4A247A] via-[#6B3FA0] to-[#2B124C] p-8 sm:p-10 text-white flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-400/20 border border-amber-300/30 text-amber-200 text-xs font-semibold uppercase tracking-wider mb-4">
              ...
              <span>Join Vayushri Care</span>
            </div>
            <h1 className="text-3xl sm:text-4xl font-bold leading-tight font-inter">
              Begin Your <span className="text-amber-300 font-extrabold">Health</span> Journey
            </h1>
            <p className="mt-3 text-purple-100 text-sm sm:text-base leading-relaxed">
              Create your patient account to book consultations, track appointment status, and access specialized reproductive & maternal healthcare.
            </p>
          </div>
          ...
          <div className="relative z-10 space-y-3.5 my-8">
            <div className="flex items-center gap-3 bg-white/10 backdrop-blur-md p-3 rounded-xl border border-white/10">
              ...
              <span className="text-xs sm:text-sm font-medium text-white/90">Top Fertility & Women's Health Experts</span>
            </div>
            <div className="flex items-center gap-3 bg-white/10 backdrop-blur-md p-3 rounded-xl border border-white/10">
              <div className="w-8 h-8 rounded-lg bg-amber-400/20 flex items-center justify-center flex-shrink-0 text-amber-300">
                <ShieldCheck className="w-4 h-4" />
              </div>
              <span className="text-xs sm:text-sm font-medium text-white/90">Private & Confidential Health Data</span>
            </div>
          </div>

          {/* Footer Note */}
          <div className="relative z-10 text-xs text-purple-200/80 border-t border-white/15 pt-4">
            Already have an account? <Link to="/login" className="text-amber-300 font-bold hover:underline">Sign In Here</Link>
          </div>
        </div>

        {/* Right Side: Signup Form */}
        <div className="md:col-span-7 p-8 sm:p-10 flex flex-col justify-center bg-white overflow-y-auto max-h-[90vh]">
          <div className="max-w-lg mx-auto w-full">
            
            {/* Header */}
            <div className="mb-6">
              <h2 className="text-3xl font-bold text-gray-900 font-inter">Create Account</h2>
              <p className="text-gray-500 text-sm mt-1">Fill in your details to register as a patient</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3.5 py-2.5 bg-gray-50/50 border border-gray-200 rounded-xl text-gray-900 text-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#6B3FA0]/30 focus:border-[#6B3FA0] transition-all"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-10 py-2.5 bg-gray-50/50 border border-gray-200 rounded-xl text-gray-900 text-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#6B3FA0]/30 focus:border-[#6B3FA0] transition-all"
                    />
                    <button
                      type="button"
              ...
              <div className="space-y-2 pt-2">
                <label className="flex items-start gap-2.5 cursor-pointer">
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-4 h-4 text-[#6B3FA0] rounded border-gray-300 focus:ring-[#6B3FA0] mt-0.5 accent-[#6B3FA0]"
                  />
                  <span className="text-xs text-gray-600 leading-relaxed">
                    I agree to the <Link to="#" className="text-[#6B3FA0] font-bold hover:underline">Terms of Service</Link> and <Link to="#" className="text-[#6B3FA0] font-bold hover:underline">Privacy Policy</Link>
                  </span>
                </label>
              </div>
              ...
              <div className="text-center pt-3 border-t border-gray-100">
                <p className="text-sm text-gray-600">
                  ...
                  <Link to="/login" className="font-bold text-[#6B3FA0] hover:text-[#4A247A] transition-colors">
                    Sign in
                  </Link>
                </p>
              </div>
