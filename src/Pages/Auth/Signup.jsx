      ...
      <div className="w-full grid md:grid-cols-2 gap-0 bg-white">
        ...
        <div className="flex flex-col justify-center p-8 md:p-16 bg-white overflow-y-auto max-h-screen">
          <div className="mb-8">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-2 font-['Playfair_Display']">Create account</h2>
            <p className="text-gray-600 font-['Lato']">Start your journey to better health today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                <label htmlFor="firstName" className="block text-sm font-medium text-gray-700 font-['Lato']">
                  First Name
                </label>
                <input
                  id="firstName"
              ...
              <div className="space-y-1">
                <label htmlFor="lastName" className="block text-sm font-medium text-gray-700 font-['Lato']">
                  Last Name
                </label>
                <input
                  id="lastName"
            ...
            {/* Phone field */}
            <div className="space-y-1">
              <label htmlFor="phone" className="block text-sm font-medium text-gray-700 font-['Lato']">
                Phone number
              </label>
              <input
                id="phone"
            ...
            {/* Date of Birth field */}
            <div className="space-y-1">
              <label htmlFor="dateOfBirth" className="block text-sm font-medium text-gray-700 font-['Lato']">
                Date of birth
              </label>
              <input
                id="dateOfBirth"
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                minLength={8}
              />
              <p className="text-xs text-gray-500 font-['Lato']">At least 8 characters</p>
            </div>

            <div className="space-y-1">
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700 font-['Lato']">
                Confirm password
              </label>
              <input
                id="confirmPassword"
            ...
            <div className="space-y-2 pt-2">
              <label className="flex items-start gap-2 cursor-pointer">
                <input
                  ...
                  onChange={handleChange}
                  className="w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-2 focus:ring-purple-500 mt-0.5 flex-shrink-0 accent-purple-600"
                  required
                />
                <span className="text-sm text-gray-700 font-['Lato']">
                  I agree to the <Link to="#" className="text-purple-600 hover:text-purple-700 font-semibold">Terms of Service</Link> and <Link to="#" className="text-purple-600 hover:text-purple-700 font-semibold">Privacy Policy</Link>
                </span>
              </label>
