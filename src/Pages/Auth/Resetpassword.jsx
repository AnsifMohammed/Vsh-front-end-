...
const ResetPassword = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main Container */}
      <div className="w-full max-w-5xl bg-white/98 backdrop-blur-xl rounded-xl shadow-[0_25px_70px_rgba(0,0,0,0.5)] overflow-hidden grid grid-cols-1 md:grid-cols-12 border border-white/30 min-h-[600px] relative z-10">
